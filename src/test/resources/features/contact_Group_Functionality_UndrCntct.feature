...
Feature: As a user, I should be able to create a new group and
  ...
  Scenario: AC02 User can add any existing contact from the groups dropdown menu existing inside that specific contact’s own info menu

  Scenario: AC03 User can see all the available groups name through the groups dropdown menu existing in the contact’s own info menu
